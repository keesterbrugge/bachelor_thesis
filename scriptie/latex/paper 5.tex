...
\makeatother
\title{Intrinsic bubbles in stock prices}
...
\subsection{R code}
The R code of function that returns the rank-based cointegration test statistics:
\begin{verbatim}
